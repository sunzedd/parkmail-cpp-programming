...
TEST(MOOD_DETERMINE_MP, EMPTY_INPUT_STRING) {
...
TEST(MOOD_DETERMINE_MP, NULLPTR_STRING) {
...
TEST(MOOD_DETERMINE_MP, NO_DIGRAPHS_IN_STRING) {
...
TEST(MOOD_DETERMINE_MP, NORMAL_EXECUTION_POSITIVE) {
    const char *const s = ":) :) :) :) :) :) :(\0";
...
TEST(MOOD_DETERMINE_MP, NORMAL_EXECUTION_NEUTRAL) {
...
TEST(MOOD_DETERMINE_MP, NORMAL_EXECUTION_NEGATIVE) {
